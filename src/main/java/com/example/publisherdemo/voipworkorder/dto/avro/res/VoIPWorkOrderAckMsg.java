...
public class VoIPWorkOrderAckMsg extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  @Deprecated public com.example.publisherdemo.voipworkorder.dto.avro.res.MessageHeader MessageHeader;
  @Deprecated public com.example.publisherdemo.voipworkorder.dto.avro.res.MessageData MessageData;
   ...
   */
  public VoIPWorkOrderAckMsg(com.example.publisherdemo.voipworkorder.dto.avro.res.MessageHeader MessageHeader, com.example.publisherdemo.voipworkorder.dto.avro.res.MessageData MessageData) {
  ...
  public void put(int field$, java.lang.Object value$) {
    switch (field$) {
    case 0: MessageHeader = (com.example.publisherdemo.voipworkorder.dto.avro.res.MessageHeader)value$; break;
    case 1: MessageData = (com.example.publisherdemo.voipworkorder.dto.avro.res.MessageData)value$; break;
    default: throw new org.apache.avro.AvroRuntimeException("Bad index");
    }
  }
   ...
   */
  public com.example.publisherdemo.voipworkorder.dto.avro.res.MessageHeader getMessageHeader() {
   ...
   */
  public void setMessageHeader(com.example.publisherdemo.voipworkorder.dto.avro.res.MessageHeader value) {
   ...
   */
  public com.example.publisherdemo.voipworkorder.dto.avro.res.MessageData getMessageData() {
    return MessageData;
  }
   ...
   * @param value the value to set.
   */
  public void setMessageData(com.example.publisherdemo.voipworkorder.dto.avro.res.MessageData value) {
   ...
   */
  public static com.example.publisherdemo.voipworkorder.dto.avro.res.VoIPWorkOrderAckMsg.Builder newBuilder() {
    return new com.example.publisherdemo.voipworkorder.dto.avro.res.VoIPWorkOrderAckMsg.Builder();
  }
   ...
   * @return A new VoIPWorkOrderAckMsg RecordBuilder
   */
  public static com.example.publisherdemo.voipworkorder.dto.avro.res.VoIPWorkOrderAckMsg.Builder newBuilder(com.example.publisherdemo.voipworkorder.dto.avro.res.VoIPWorkOrderAckMsg.Builder other) {
    if (other == null) {
      return new com.example.publisherdemo.voipworkorder.dto.avro.res.VoIPWorkOrderAckMsg.Builder();
    } else {
      return new com.example.publisherdemo.voipworkorder.dto.avro.res.VoIPWorkOrderAckMsg.Builder(other);
    }
  }
   ...
   * @return A new VoIPWorkOrderAckMsg RecordBuilder
   */
  public static com.example.publisherdemo.voipworkorder.dto.avro.res.VoIPWorkOrderAckMsg.Builder newBuilder(com.example.publisherdemo.voipworkorder.dto.avro.res.VoIPWorkOrderAckMsg other) {
    if (other == null) {
      return new com.example.publisherdemo.voipworkorder.dto.avro.res.VoIPWorkOrderAckMsg.Builder();
    } else {
      return new com.example.publisherdemo.voipworkorder.dto.avro.res.VoIPWorkOrderAckMsg.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<VoIPWorkOrderAckMsg>
    ...
    private com.example.publisherdemo.voipworkorder.dto.avro.res.MessageHeader MessageHeader;
    private com.example.publisherdemo.voipworkorder.dto.avro.res.MessageHeader.Builder MessageHeaderBuilder;
    private com.example.publisherdemo.voipworkorder.dto.avro.res.MessageData MessageData;
    private com.example.publisherdemo.voipworkorder.dto.avro.res.MessageData.Builder MessageDataBuilder;
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.example.publisherdemo.voipworkorder.dto.avro.res.VoIPWorkOrderAckMsg.Builder other) {
      super(other);
      ...
      if (other.hasMessageHeaderBuilder()) {
        this.MessageHeaderBuilder = com.example.publisherdemo.voipworkorder.dto.avro.res.MessageHeader.newBuilder(other.getMessageHeaderBuilder());
      }
      ...
      if (other.hasMessageDataBuilder()) {
        this.MessageDataBuilder = com.example.publisherdemo.voipworkorder.dto.avro.res.MessageData.newBuilder(other.getMessageDataBuilder());
      }
    }
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.example.publisherdemo.voipworkorder.dto.avro.res.VoIPWorkOrderAckMsg other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.MessageHeader)) {
        this.MessageHeader = data().deepCopy(fields()[0].schema(), other.MessageHeader);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.publisherdemo.voipworkorder.dto.avro.res.VoIPWorkOrderAckMsg.Builder setMessageHeader(com.example.publisherdemo.voipworkorder.dto.avro.res.MessageHeader value) {
     ...
     * @return This builder.
     */
    public com.example.publisherdemo.voipworkorder.dto.avro.res.MessageHeader.Builder getMessageHeaderBuilder() {
      if (MessageHeaderBuilder == null) {
        if (hasMessageHeader()) {
          setMessageHeaderBuilder(com.example.publisherdemo.voipworkorder.dto.avro.res.MessageHeader.newBuilder(MessageHeader));
        } else {
          setMessageHeaderBuilder(com.example.publisherdemo.voipworkorder.dto.avro.res.MessageHeader.newBuilder());
        }
      }
     ...
     * @return This builder.
     */
    public com.example.publisherdemo.voipworkorder.dto.avro.res.VoIPWorkOrderAckMsg.Builder setMessageHeaderBuilder(com.example.publisherdemo.voipworkorder.dto.avro.res.MessageHeader.Builder value) {
      clearMessageHeader();
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.publisherdemo.voipworkorder.dto.avro.res.VoIPWorkOrderAckMsg.Builder clearMessageHeader() {
      MessageHeader = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.publisherdemo.voipworkorder.dto.avro.res.VoIPWorkOrderAckMsg.Builder setMessageData(com.example.publisherdemo.voipworkorder.dto.avro.res.MessageData value) {
     ...
     * @return This builder.
     */
    public com.example.publisherdemo.voipworkorder.dto.avro.res.MessageData.Builder getMessageDataBuilder() {
      if (MessageDataBuilder == null) {
        if (hasMessageData()) {
          setMessageDataBuilder(com.example.publisherdemo.voipworkorder.dto.avro.res.MessageData.newBuilder(MessageData));
        } else {
          setMessageDataBuilder(com.example.publisherdemo.voipworkorder.dto.avro.res.MessageData.newBuilder());
        }
      }
     ...
     * @return This builder.
     */
    public com.example.publisherdemo.voipworkorder.dto.avro.res.VoIPWorkOrderAckMsg.Builder setMessageDataBuilder(com.example.publisherdemo.voipworkorder.dto.avro.res.MessageData.Builder value) {
      clearMessageData();
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.publisherdemo.voipworkorder.dto.avro.res.VoIPWorkOrderAckMsg.Builder clearMessageData() {
      MessageData = null;
    ...
    public VoIPWorkOrderAckMsg build() {
      try {
        ...
        if (MessageHeaderBuilder != null) {
          ...
          record.MessageHeader = fieldSetFlags()[0] ? this.MessageHeader : (com.example.publisherdemo.voipworkorder.dto.avro.res.MessageHeader) defaultValue(fields()[0]);
        }
        if (MessageDataBuilder != null) {
          try {
          ...
          record.MessageData = fieldSetFlags()[1] ? this.MessageData : (com.example.publisherdemo.voipworkorder.dto.avro.res.MessageData) defaultValue(fields()[1]);
        }
        return record;
      } catch (org.apache.avro.AvroMissingFieldException e) {
        throw e;
    ...
    throws java.io.IOException
  {
    ...
    if (fieldOrder == null) {
      if (this.MessageHeader == null) {
        this.MessageHeader = new com.example.publisherdemo.voipworkorder.dto.avro.res.MessageHeader();
      }
      ...
      if (in.readIndex() != 1) {
        ...
        if (this.MessageData == null) {
          this.MessageData = new com.example.publisherdemo.voipworkorder.dto.avro.res.MessageData();
        }
