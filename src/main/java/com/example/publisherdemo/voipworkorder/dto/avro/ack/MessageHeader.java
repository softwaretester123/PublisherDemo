...
public class MessageHeader extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -6207699516384998892L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"MessageHeader\",\"namespace\":\"com.example.publisherdemo.voipworkorder.dto.avro.ack\",\"fields\":[{\"name\":\"TransactionSequenceId\",\"type\":\"string\"},{\"name\":\"TransactionDateTime\",\"type\":\"string\"},{\"name\":\"MessageName\",\"type\":\"string\"},{\"name\":\"Origin\",\"type\":\"string\"},{\"name\":\"CorrelationId\",\"type\":\"string\"}]}");
   ...
   */
  public static com.example.publisherdemo.voipworkorder.dto.avro.ack.MessageHeader.Builder newBuilder() {
    return new com.example.publisherdemo.voipworkorder.dto.avro.ack.MessageHeader.Builder();
  }
   ...
   * @return A new MessageHeader RecordBuilder
   */
  public static com.example.publisherdemo.voipworkorder.dto.avro.ack.MessageHeader.Builder newBuilder(com.example.publisherdemo.voipworkorder.dto.avro.ack.MessageHeader.Builder other) {
    return new com.example.publisherdemo.voipworkorder.dto.avro.ack.MessageHeader.Builder(other);
  }
   ...
   * @return A new MessageHeader RecordBuilder
   */
  public static com.example.publisherdemo.voipworkorder.dto.avro.ack.MessageHeader.Builder newBuilder(com.example.publisherdemo.voipworkorder.dto.avro.ack.MessageHeader other) {
    return new com.example.publisherdemo.voipworkorder.dto.avro.ack.MessageHeader.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<MessageHeader>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.example.publisherdemo.voipworkorder.dto.avro.ack.MessageHeader.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.example.publisherdemo.voipworkorder.dto.avro.ack.MessageHeader other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.TransactionSequenceId)) {
        this.TransactionSequenceId = data().deepCopy(fields()[0].schema(), other.TransactionSequenceId);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.publisherdemo.voipworkorder.dto.avro.ack.MessageHeader.Builder setTransactionSequenceId(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.publisherdemo.voipworkorder.dto.avro.ack.MessageHeader.Builder clearTransactionSequenceId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.publisherdemo.voipworkorder.dto.avro.ack.MessageHeader.Builder setTransactionDateTime(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.publisherdemo.voipworkorder.dto.avro.ack.MessageHeader.Builder clearTransactionDateTime() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.publisherdemo.voipworkorder.dto.avro.ack.MessageHeader.Builder setMessageName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.publisherdemo.voipworkorder.dto.avro.ack.MessageHeader.Builder clearMessageName() {
      MessageName = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.publisherdemo.voipworkorder.dto.avro.ack.MessageHeader.Builder setOrigin(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.publisherdemo.voipworkorder.dto.avro.ack.MessageHeader.Builder clearOrigin() {
      Origin = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.publisherdemo.voipworkorder.dto.avro.ack.MessageHeader.Builder setCorrelationId(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.publisherdemo.voipworkorder.dto.avro.ack.MessageHeader.Builder clearCorrelationId() {
      CorrelationId = null;
