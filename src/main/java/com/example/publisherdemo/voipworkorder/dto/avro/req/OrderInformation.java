...
public class OrderInformation extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -8064840868524138572L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"OrderInformation\",\"namespace\":\"com.example.publisherdemo.voipworkorder.dto.avro.req\",\"fields\":[{\"name\":\"SAN\",\"type\":[\"null\",\"string\"]}]}");
   ...
   */
  public static com.example.publisherdemo.voipworkorder.dto.avro.req.OrderInformation.Builder newBuilder() {
    return new com.example.publisherdemo.voipworkorder.dto.avro.req.OrderInformation.Builder();
  }
   ...
   * @return A new OrderInformation RecordBuilder
   */
  public static com.example.publisherdemo.voipworkorder.dto.avro.req.OrderInformation.Builder newBuilder(com.example.publisherdemo.voipworkorder.dto.avro.req.OrderInformation.Builder other) {
    if (other == null) {
      return new com.example.publisherdemo.voipworkorder.dto.avro.req.OrderInformation.Builder();
    } else {
      return new com.example.publisherdemo.voipworkorder.dto.avro.req.OrderInformation.Builder(other);
    }
  }
   ...
   * @return A new OrderInformation RecordBuilder
   */
  public static com.example.publisherdemo.voipworkorder.dto.avro.req.OrderInformation.Builder newBuilder(com.example.publisherdemo.voipworkorder.dto.avro.req.OrderInformation other) {
    if (other == null) {
      return new com.example.publisherdemo.voipworkorder.dto.avro.req.OrderInformation.Builder();
    } else {
      return new com.example.publisherdemo.voipworkorder.dto.avro.req.OrderInformation.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<OrderInformation>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.example.publisherdemo.voipworkorder.dto.avro.req.OrderInformation.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.example.publisherdemo.voipworkorder.dto.avro.req.OrderInformation other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.SAN)) {
        this.SAN = data().deepCopy(fields()[0].schema(), other.SAN);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.publisherdemo.voipworkorder.dto.avro.req.OrderInformation.Builder setSAN(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.publisherdemo.voipworkorder.dto.avro.req.OrderInformation.Builder clearSAN() {
      SAN = null;
